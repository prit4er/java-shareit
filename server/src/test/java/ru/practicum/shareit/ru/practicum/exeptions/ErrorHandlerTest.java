package ru.practicum.shareit.ru.practicum.exeptions;
...
import ru.practicum.shareit.exeptions.GlobalExceptionHandler;
...
@WebMvcTest(controllers = {GlobalExceptionHandler.class, ErrorHandlerTest.TestController.class})
