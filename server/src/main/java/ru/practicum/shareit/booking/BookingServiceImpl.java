...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDto approveBooking(Long bookingId, Long ownerId, boolean approved) {
        ...
        if (!Objects.equals(booking.getItem().getOwnerId(), ownerId)) {
            throw new ValidationException("Only the owner can approve the booking");
        }
    ...
    @Override
    public Collection<BookingDto> getBookingsByBookerIdAndState(Long bookerId, BookingStatus state) {
