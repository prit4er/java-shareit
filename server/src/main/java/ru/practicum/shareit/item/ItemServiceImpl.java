...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto addItem(ItemDto itemDto, long userId) {
        ...
        Item item = ItemDtoMapper.toEntity(itemDto, owner, request);
    ...
    @Override
    public ItemDto updateItem(MainItemRequestDto itemUpdateDto, long userId, long itemId) {
        ...
        ItemDtoMapper.updateItemFields(item, itemUpdateDto);
